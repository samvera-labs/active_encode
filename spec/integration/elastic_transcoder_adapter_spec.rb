...
describe ActiveEncode::EngineAdapters::ElasticTranscoderAdapter do
  ...
  describe "#create" do
    let(:job) { job_created }
    let(:create_output) { [{id: "2", :url=>"hls0400k/e8fe80f5b7063b12d567b90c0bdf6322116bba11ac458fe9d62921644159fe4a", :label=>nil, :segment_duration=>"2.0"}] }
  ...
  describe "#find" do
    context "a running encode" do
      ...
      let(:running_output) { [{id: "2", url: "hls0400k/e8fe80f5b7063b12d567b90c0bdf6322116bba11ac458fe9d62921644159fe4a", label: nil, :segment_duration=>"2.0"}] }
    ...
    context "a completed encode" do
      ...
      let(:completed_output) { [{id: "2", url: "hls0400k/e8fe80f5b7063b12d567b90c0bdf6322116bba11ac458fe9d62921644159fe4a", label: nil, :width=>400, :height=>224, :video_framerate=>"25", :file_size=>6901104, :duration=>117353, :segment_duration=> "2.0"}] }
